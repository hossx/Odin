...
public class KLineActivity extends FragmentActivity {
    ...
    private void initCandleStickChart() {
        ...
        // 最大价格
        candlestickchart.setMaxValue(3000);
        // 最小价格
        candlestickchart.setMinValue(800);
        ...
        candlestickchart.setStickAlignType(ICrossLines.BIND_TO_TYPE_BOTH);
        ...
        if (ja != null) {
            for (int i = 0; i < ja.length(); ++i) {
                try {
                    ...
                    datas.add(new OHLCEntity(open,high, low, close, (int) ts));
