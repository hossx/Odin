...
public class AddBankCardFragment extends DialogFragment implements View.OnClickListener {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        Button addBankCardAction = (Button) view.findViewById(R.id.add_bank_card_action);
        addBankCardAction.setOnClickListener(this);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
                            ...
                            public void onRender(NetworkRequest s) {
                                ...
                                if (s.getApiStatus() != NetworkRequest.ApiStatus.SUCCEED) {
                                    if (s.getApiStatus() == NetworkRequest.ApiStatus.UNAUTH) {
                                        Intent intent = Util.toLoginFromAuthFail(AddBankCardFragment.this.getActivity(), true);
            ...
            case R.id.add_bank_card_action:
                ...
                task = new NetworkAsyncTask(Constants.ADD_BANK_CARD_URL, Constants.HttpMethod.POST)
                        .setOnSucceedListener(new OnApiResponseListener())
                        .setOnFailedListener(new OnApiResponseListener())
                        .setRenderListener(new NetworkAsyncTask.OnPostRenderListener() {
                            @Override
